...
public class LowBarLowGoal extends CommandGroup {
	public LowBarLowGoal() {
		...
		this.addSequential(new ArcadeDriveCommand(0.7, 0.0, 2.5));
		this.addSequential(new ArcadeDriveCommand(0.0, 0.0, 1.0));
		this.addSequential(new ArcadeDriveCommand(0.0, 0.5, 1.1));
		this.addSequential(new ArcadeDriveCommand(0.0, 0.0, 0.5));
		this.addSequential(new ArcadeDriveCommand(0.6, 0.0, 3.0));
		//this.addSequential(new IntakeShooterCommand(true, Constants.Intake.INTAKE_OUT, 0.0));
		this.addSequential(new ArcadeDriveCommand(0.1, 0.0, 1.0));
		this.addSequential(new IntakeShooterCommand(true, 0.0, 0.0));
		this.addSequential(new ArcadeDriveCommand(0.0, 0.0, 0.5));
	}

	public String toString() {
		return "LowBarLowGoal";
	}
}
